...
interface FreeDeliveryClientProps {
...
export default function FreeDeliveryClient({
  category,
  initialProducts,
}: FreeDeliveryClientProps) {
  ...
  useEffect(() => {
    ...
    const getTimerStartTime = () => {
      const stored = localStorage.getItem('freeDeliveryTimerStart');
      if (stored) {
        ...
        if (elapsed >= 600000) {
          ...
          localStorage.setItem('freeDeliveryTimerStart', newStartTime.toString());
          return newStartTime;
        }
        return startTime;
      } else {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Free Delivery Category Not Found</h1>
          <p className="text-gray-600 mb-4">
            Please create a product category with slug &quot;free-delivery&quot; in WordPress.
          </p>
          <Link
            href="/"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative w-full h-[300px] md:h-[400px] bg-gradient-to-br from-teal-500 to-blue-500">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-4 text-sm text-gray-600">
          Showing {initialProducts.length} {initialProducts.length === 1 ? 'product' : 'products'} with free delivery
        </div>

        {initialProducts.length === 0 ? (
          <div className="text-center py-12">
            <Truck className="w-16 h-16 text-gray-300 mx-auto mb-4" />
            <p className="text-gray-600 text-lg">No free delivery products available right now.</p>
            <p className="text-gray-500 text-sm mt-2">Check back soon for free shipping offers!</p>
          </div>
        ) : (
