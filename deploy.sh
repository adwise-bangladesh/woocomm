...
# 🚀 Automated Deployment Script for m.zonash.com
# This script deploys your WooCommerce frontend from GitHub
...
# Start/restart PM2
print_status "Starting/restarting application with PM2..."
...
sudo chmod -R 644 "$APP_DIR/.next/static/"
